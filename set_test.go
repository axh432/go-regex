...
func TestSet(t *testing.T) {
	...
	t.Run("when given a character that is not in the set return false", func(t *testing.T) {
		...
		expected := MatchTree{
			...
			Type:    "Set",
			Children: []MatchTree{
				{IsValid: false, Value: "", Type: "SetOfCharacters", Children: []MatchTree(nil), DebugLine: "SetOfCharacters:[a], NoMatch: 'd' not found in set"},
				{IsValid: false, Value: "", Type: "SetOfCharacters", Children: []MatchTree(nil), DebugLine: "SetOfCharacters:[b], NoMatch: 'd' not found in set"},
				{IsValid: false, Value: "", Type: "SetOfCharacters", Children: []MatchTree(nil), DebugLine: "SetOfCharacters:[c], NoMatch: 'd' not found in set"}},
	...
	t.Run("when given a string and the first character does not match return false", func(t *testing.T) {
		...
		expected := MatchTree{
			...
			Type:    "Set",
			Children: []MatchTree{
				{IsValid: false, Value: "", Type: "SetOfCharacters", Children: []MatchTree(nil), DebugLine: "SetOfCharacters:[a], NoMatch: 'x' not found in set"},
				{IsValid: false, Value: "", Type: "SetOfCharacters", Children: []MatchTree(nil), DebugLine: "SetOfCharacters:[b], NoMatch: 'x' not found in set"},
				{IsValid: false, Value: "", Type: "SetOfCharacters", Children: []MatchTree(nil), DebugLine: "SetOfCharacters:[c], NoMatch: 'x' not found in set"},
			},
			DebugLine: "Set:[], NoMatch:string does not match the given subexpressions",
		}
	...
	t.Run("when given an empty string return false", func(t *testing.T) {
		...
		expected := MatchTree{
			...
			Type:    "Set",
			Children: []MatchTree{
				{IsValid: false, Value: "", Type: "SetOfCharacters", Children: []MatchTree(nil), DebugLine: "SetOfCharacters:[a], NoMatch:reached end of string before finished"},
				{IsValid: false, Value: "", Type: "SetOfCharacters", Children: []MatchTree(nil), DebugLine: "SetOfCharacters:[b], NoMatch:reached end of string before finished"},
				{IsValid: false, Value: "", Type: "SetOfCharacters", Children: []MatchTree(nil), DebugLine: "SetOfCharacters:[c], NoMatch:reached end of string before finished"},
			},
			DebugLine: "Set:[], NoMatch:string does not match the given subexpressions"}
